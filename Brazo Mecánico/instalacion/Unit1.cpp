...
void __fastcall TForm1::Image1Click(TObject *Sender)
{
        ...
        for(i=0;txt[i]!='\0';i++)
                if(txt[i+1]=='\\')
                        ...
                        s=s+txt[i];
        s=s+":\\Archivos de programa\\Internet Explorer\\IEXPLORE.EXE \\Brazo Mecánico\\PÁG WEB\\CARÁTULA\\Index12.htm";
//         WinExec("C:\\Archivos de programa\\Internet Explorer\\IEXPLORE.EXE \\Brazo Mecánico\\PÁG WEB\\CARÁTULA\\Index12.htm",SW_MAXIMIZE);
